...
class Home {
    ...
    async initNews() {
        ...
        if (this.news) {
                ...
                blockNews.innerHTML = `
                    <div class="news-header">
                        <div class="header-text">
                            <div class="title">Aktualnie brak wiadomości.</div>
                        </div>
                    </div>
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>Tutaj możesz śledzić wszystkie wiadomości związane z serwerem.</p>
                        </div>
                    </div>`
            ...
            blockNews.innerHTML = `
                ...
                <div class="news-content">
                    <div class="bbWrapper">
                        <p>Nie można skontaktować się z serwerem.</p>
                    </div>
                </div>`
            // news.appendChild(blockNews);
        }
    ...
    async initStatusServer() {
        ...
        if (!serverPing.error) {
            ...
            nameServer.textContent = 'Serwer niedostępny';
