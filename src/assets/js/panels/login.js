...
class Login {
    ...
    loginMojang() {
        ...
        loginBtn.addEventListener("click", () => {
            ...
            infoLogin.innerHTML = "Bieżące połączenie..";


            if (mailInput.value == "") {
                infoLogin.innerHTML = "Wpisz swój adres e-mail lub nazwę użytkownika"
            ...
            if (passwordInput.value == "") {
                infoLogin.innerHTML = "Wprowadź hasłoe"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            Mojang.getAuth(mailInput.value, passwordInput.value).then(account_connect => {
                ...
                mailInput.disabled = false;
                passwordInput.disabled = false;
                infoLogin.innerHTML = 'Nieprawidłowy adres e-mail lub hasło'
            })
        })
    }
    ...
    loginOffline() {
        ...
        loginBtn.addEventListener("click", () => {
            ...
            if (mailInput.value == "") {
                infoLogin.innerHTML = "Wpisz swój adres e-mail / nazwę użytkownika"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            if (mailInput.value.length < 3) {
                infoLogin.innerHTML = "Twoja nazwa użytkownika musi mieć co najmniej 3 znakis"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
